...
namespace SF365.Plugins
{
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            localcontext.Trace(string.Format("Entered {0}.Execute()", this.ChildClassName));
            ...
            {
                localcontext.Trace(string.Format("Exception: {0}", e.ToString()));
            ...
            {
                localcontext.Trace(string.Format("Exiting {0}.Execute()", this.ChildClassName));
            }
        }
